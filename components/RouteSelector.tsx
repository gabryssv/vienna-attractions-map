      ...
      {isRouteMode ? (
        ...
        <div className="space-y-2">
          {viennaAttractions.map((attraction) => (
            <div
              key={attraction.id}
              className={`p-3 rounded-lg border cursor-pointer transition-all duration-200 hover:border-neutral-600 ${
            ...
            >
              <h3 className={`font-bold text-xs mb-1 ${
                selectedAttraction?.id === attraction.id ? 'text-green-400' : 'text-white'
              }`}>
                {attraction.name}
              </h3>
              <p className="text-xs text-neutral-400 mb-1">
